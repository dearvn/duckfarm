        ...
        <div class="min-[500px]:pl-10 sm:shrink-0 sm:pl-14 xl:pl-0">
            ...
            >
                <div class="relative space-y-3 font-black">
                    ...
                    <div x-ref="title">
                        ...
                        <div class="text-4xl lg:text-5xl">
                            {{ trans('site.resource.Easier farm management starts here')}}
                            <span
                ...
                <div class="relative pt-5">
                    ...
                    >
                        {{ trans('site.resource.all-in-one farm management software') }}
                        <br />
                        {{ trans('site.resource.lets you focus on your passion') }}
                        <br />
                        {{ trans('site.resource.not your paperwork') }}
                    </div>
