        ...
        <ul class="-mx-3 select-none space-y-2">
            ...
            <li>
                <a
                    ...
                    @class([
                        'group/sidebar-link block w-full rounded-lg px-4 py-2 transition duration-300',
                        'font-medium hover:bg-merino' => ! request()->routeIs('features*'),
                        'bg-merino font-black' => request()->routeIs('features*'),
                    ])
                >
                    <div
                        @class([
                            'transition duration-300',
                            'group-hover/sidebar-link:translate-x-1' => ! request()->routeIs('features*'),
                        ])
                    >
